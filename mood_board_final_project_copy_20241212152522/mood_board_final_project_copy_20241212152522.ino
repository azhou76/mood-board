...
// Game variables
// int birdY = 4;        // Bird's vertical position
// int birdX = 1;        // Bird's fixed horizontal position
// int obstacleX = 7;    // Obstacle's horizontal position
// int obstacleGap = 3;  // Gap position in the obstacle
// int score = 0;        // Player's score
// bool isGameOver = false;
...
// unsigned long lastUpdateTime = 0;
// unsigned long flapTime = 0;
// int updateInterval = 200; // Game speed
// int gravity = 1;          // Bird falls every cycle
...
void drawWave(int soundValue, int soundValues[], int filled) {
  ...
  // //add new wave height to end of the array
  // wave[15] = newHeight;
  ...
  //     // draw the a single column based on the recent val
...
void drawWaveParty(int soundValue, unsigned long currTime, unsigned long &lastChangeColorTime) {
  ...
  // Add new wave height to the end of the array
  wave[15] = newHeight;
...
void loop() {
  ...
  case MODE_GAME: {
    ...
    // unsigned long lastUpdateTime = 0;
    // unsigned long flapTime = 0;
    // int updateInterval = 400; // Game speed
    // int gravity = 1;          // Bird falls every cycle
    if (isGameOver) {
      showGameOver();
